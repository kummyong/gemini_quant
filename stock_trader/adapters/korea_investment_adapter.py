# adapters/korea_investment_adapter.py
"""Broker adapters for Korea Investment and NH Investment.
The KoreaInvestmentAdapter now supports optional real KIS REST API calls (via the api package).
NhInvestmentAdapter remains a mock implementation.
"""

from core.broker_interface import BrokerInterface
from typing import Dict, List
import logging
from api.korea_investment_api import KoreaInvestmentAPI


class KoreaInvestmentAdapter(BrokerInterface):
    """Adapter for Korea Investment Securities.
    It works in two modes:
    * Real mode – uses KoreaInvestmentAPI when credentials are available.
    * Mock mode – falls back to in‑memory simulation.
    """
