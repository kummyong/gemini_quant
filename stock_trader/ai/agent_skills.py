...
...
from stock_trader.config import STOCK_TRADER_DIR as BASE_DIR, SECRETARY_DIR, DB_PATH
sys.path.append(SECRETARY_DIR)

# 모듈 임포트 시도
try:
    from stock_trader.broker.kiwoom.Kiwoom_MCP_Server.kiwoom_mcp import KiwoomConfig, KiwoomApiManager
