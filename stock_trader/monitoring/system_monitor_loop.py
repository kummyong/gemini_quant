...
from stock_trader.config import STOCK_TRADER_DIR as BASE_DIR, LOG_DIR

MONITOR_SCRIPT = os.path.join(BASE_DIR, "monitoring", "system_monitor.py")
TREND_SCRIPT = os.path.join(BASE_DIR, "monitoring", "system_trend_reporter.py")
